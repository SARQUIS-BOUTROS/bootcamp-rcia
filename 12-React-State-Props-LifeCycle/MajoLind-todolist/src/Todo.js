    ...
    render(){
        ...
        <Row>
            ...
            <Col xs={6} md={2}>
                ...
                <Button bsStyle={this.props.Element.done? "warning" : "success"} onClick={()=>{this.props.onDone(this.props.Key)}}>
                <Glyphicon glyph={this.props.Element.done? "glyphicon glyphicon-remove" : "glyphicon glyphicon-ok"} />
                </Button>
            </Col>
            <Col xs={6} md={2} ></Col>
        </Row>
